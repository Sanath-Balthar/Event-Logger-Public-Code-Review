        ...
        <div className="flex flex-col items-center">
           ...
           isSidebar?(
            ...
            <div className="flex flex-col items-center w-[50px] min-h-screen pt-5 bg-white">                    
                ...
                <button data-testid="contracts-button"  className="flex flex-row justify-center  text-black my-1 py-2 rounded  hover:bg-blue-900 hover:text-white transition" onClick={onContracts}><Grading className="mx-1" /></button>
