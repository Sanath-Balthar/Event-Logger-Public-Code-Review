...
function extractEvent(newEventLog,oldkwList){
    ...
    let nLsplit = newEventLog.split("\n")
        ...
        let tempdupKWList = [];
            ...
            // Compare the received unique KW list with the one saved already in MongoDB and then Send the new unique KW List to DB
            // let noIndexKWList=[];
            // if(oldKWList.length!==0){
            //     uniqTempKWList.map((element)=>{
            //         var uniqKWbool = false;
            //         for(let i=0; i<oldKWList.length; i++){
                        
            //             if(element.keyword!==oldKWList[i].keyword){
            //                 uniqKWbool = true;
            //             }else{
            //                 uniqKWbool = false;
            //             }
            ...
            //             }
            //         if(uniqKWbool){
            //             noIndexKWList.push(element);
            //         }

            //     })
            // }else{
            //     noIndexKWList=uniqTempKWList;
            // }
        ...
        // update the new events List to be displayed here.   
